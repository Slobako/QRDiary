...
@implementation QRDCoreDataStore
...
+(instancetype)sharedDataStore {
    static QRDCoreDataStore *_sharedDataStore = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedDataStore = [[QRDCoreDataStore alloc]init];
        _sharedDataStore.savedScans = [[NSMutableArray alloc]init];
    });
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"QRDiary" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"QRDiary.sqlite"];
    NSError *error = nil;
